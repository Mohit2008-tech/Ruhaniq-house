...
import { config, orderOnWhatsApp } from "@/lib/config";
import { products, values, taglines } from "@/lib/constants";
    ...
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          <FadeIn delay={100}>
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium italic text-foreground mb-6 leading-tight">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {values.map((value, i) => {
              ...
              return (
                <FadeIn key={i} delay={i * 100} className="flex flex-col items-center gap-3">
      ...
      <section id="products" className="py-24 bg-background relative">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <FadeIn>
              <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-4">Our Creations</h2>
              ...
              <FadeIn key={i} delay={i * 100}>
                <Card className="group overflow-hidden rounded-3xl border-0 shadow-sm hover:shadow-xl transition-all duration-500 bg-card h-full flex flex-col hover:-translate-y-2">
                  <div className="relative h-72 overflow-hidden">
                    <img src={product.img} alt={product.title} className="w-full h-full object-cover object-[center_30%] transition-transform duration-700 group-hover:scale-105 group-hover:brightness-105" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                    <div className="absolute bottom-4 left-6 right-6">
                      <h3 className="font-serif text-xl font-semibold text-white drop-shadow-lg shadow-black">{product.title}</h3>
                    </div>
                  </div>
      ...
      <section id="video" className="py-24 bg-muted/50">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-12">
            <FadeIn>
              <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-4">The Magic Behind Every Piece</h2>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <FadeIn>
              <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-4">Beautiful Art, Honest Prices</h2>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 max-w-xl">
              <FadeIn delay={100}>
                <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-6">The Story of Ruhaniq</h2>
                <div className="prose prose-lg prose-p:font-light prose-p:leading-relaxed text-foreground/80">
                  ...
                  <p className="mb-4">
                    Ruhaniq is the dream of two best friends who wanted to turn their passions into something meaningful, so others could feel the same warmth and love that we pour into every creation. 


                  </p>
                  <p>
                   From hand-poured candles and handcrafted roses to crochet, embroidery, resin keepsakes, and gift hampers, every piece is made with patience, care and a little piece of our hearts. We don't just create products; we create memories, emotions, and moments that can be cherished forever.
                  </p>
                  <p>
                    It's not just a brand; it's something we have kept within our hearts for a long time. It was hidden from the world, and now we have finally given it a name "RUHANIQ".
                  </p>
                </div>
              </FadeIn>
            </div>
      ...
      {/* <section className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <FadeIn>
              <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-4">Words from Our Customers</h2>
            </FadeIn>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="bg-white rounded-[3rem] shadow-xl overflow-hidden flex flex-col md:flex-row">
            <div className="md:w-5/12 bg-primary p-12 text-white flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="font-serif text-3xl font-medium mb-4">Let's create something beautiful together</h2>
              ...
              <div className="relative z-10 space-y-6">
                <a href={config.instagramUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/90 hover:text-white transition-colors group">
                  <div className="w-12 h-12 round668ed-full bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors">
      ...
      <a
        href={`https://wa.me/${config.whatsappNumber}?text=${encodeURIComponent("*Hello Ruhaniq!*\n\nI've been admiring your beautiful handmade creations and would love to place an order!\n\nCould you please help me explore your collection?\n\nThank you!")}`}
        target="_blank"
        ...
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-top-5 fade-in duration-300">
          <div className="bg-white rounded-2xl shadow-2xl border border-green-200 px-6 py-4 flex items-center gap-4 min-w-[320px]">
            ...
            <div className="flex-1">
              <h4 className="font-serif font-semibold text-foreground text-lg">Feedback Saved! 💕</h4>
              <p className="text-foreground/70 text-sm">Thank you! We'll get back to you soon.</p>
            </div>
            <button 
      ...
      {formError && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-top-5 fade-in duration-300">
          <div className="bg-white rounded-2xl shadow-2xl border border-red-200 px-6 py-4 flex items-center gap-4 min-w-[320px]">
            <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">
              <AlertCircle className="w-6 h-6 text-red-600" />
            </div>
            <div className="flex-1">
              <h4 className="font-serif font-semibold text-foreground text-lg">Oops! Something went wrong</h4>
              <p className="text-foreground/70 text-sm">Please re-enter your feedback. We can't miss your thoughts! 🙏</p>
            </div>
            <button 
